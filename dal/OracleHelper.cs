...
namespace dal
{
    public abstract class OracleHelper
    {
        ...
        public static string ConnectionStringLocalTransaction = @"Data Source=SZDXBASE;Persist Security Info=True;User ID=SYSTEM;Password=123456;Unicode=True";
        ...
        public static OracleDataReader ExecuteReader(string connectionString, CommandType cmdType, string cmdText, params OracleParameter[] commandParameters)
        {
            ...
            try
            {
                //调用 PrepareCommand 方法，对OracleCommand 对象设置参数
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters);
                //调用OracleCommand  的 ExecuteReader 方法
        ...
        /// <remarks>
        /// 举例:  
        ///  Dataset ds = ExecuteReader(connString, CommandType.StoredProcedure, "PublishOrders", new OracleParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">一个有效的连接字符串</param>
        /// <param name="commandType">命令类型(存储过程, 文本, 等等)</param>
        /// <param name="commandText">存储过程名称或者sql命令语句</param>
